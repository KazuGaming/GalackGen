...
const Nombot = "GalackGenv2 Skiddddd" 
...
const moment = require('moment');
  ...
  bot.user.setActivity("*help - GalackGenv2 Skiddddd");
});
        ...
        if (generated.has(message.author.id)) {	
            ...
            let account = JSON.parse(data)
                ...
                await message.author.send({embed: {	
                    ...
                    "color": 3092790,  
                    "image": {
                    "url": "https://i.imgur.com/OPelbab.png"
                    },
                    "footer": {   
                        "text": `© 2021 ${Nombot}`    
                    },  
...
if(command === "botinfo") {	
    ...
    const botinfo = new Discord.RichEmbed()
      ...
      .addField('Développeur de la source', `\`GalackQSM#0895\``, true) //NE PAS TOUCHER CETTE LIGNE
      .setFooter(`Leak by kanekiWeb`)
      .setTimestamp()
      .setColor("#2f3136");
...
if(command === "help") {	
    ...
    message.channel.send(embed);
      ...
      const embed = new Discord.RichEmbed()
      .setTitle(`Commandes de GalackGenv2 Skiddddd`)
      .setURL("https://github.com/KanekiWeb")
      .setThumbnail(message.guild.iconURL)
      .setDescription(`Voici les commandes de GalackGenv2 Skiddddd`)
      .addField(`${prefix}gen [nom de service]`, '`générer un compte de ce service`')
      .addField(`${prefix}check [nom de service]`, '`vérifier le nombre de comptes sur ce serveur`')
      .addField(`${prefix}stock`, '`vérifier les services et les comptes`')
